...
<div class="Navbody">
    ...
    <?php if (check_login()) : ?>
        <div class="navbar-right">
            ...
            <a href="/university/csun-test.php" id="University" title="My University"><i class="fa-solid fa-graduation-cap fa-flip-horizontal fa-2xl <?= check_active('/university'); ?>"></i></a>
            <div class="dropdown">
