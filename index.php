...
<!DOCTYPE html>
<html lang="en">
  <head> <?php include($_SERVER['DOCUMENT_ROOT'] . "/includes/head.php"); ?> </head>
  <body>
    <header id="home-logout-header"> <?php include($_SERVER['DOCUMENT_ROOT'] . "/includes/header.php"); ?>
      <link rel="stylesheet" type="text/css" href="/styles/home/
				<?= !check_login() ? "logged-out" : "logged-in"; ?>.css">
    </header>
    <main> <?php if (!check_login()) : ?> <div class="home-logout-body">
    ...
    <footer> <?php include($_SERVER['DOCUMENT_ROOT'] . "/includes/footer.php"); ?>This is the footer</footer>
  </body>
</html>